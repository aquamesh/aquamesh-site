...
export default function PlatformHero() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(28,157,187,0.3),transparent_32%),radial-gradient(circle_at_bottom_right,rgba(148,210,189,0.16),transparent_26%)]" />
