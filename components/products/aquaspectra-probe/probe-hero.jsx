...
export default function ProbeHero() {
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden border-y border-white/10 bg-slate-950/80">
        ...
        <SiteContainer className="relative px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
          <div className="mx-auto flex max-w-5xl flex-col items-center text-center" data-aos="fade-up">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-100 sm:text-xl">
              ...
              deployable body built for autonomous monitoring programs.
            </p>
            <div className="relative mt-10 w-full max-w-3xl sm:mt-12" style={{ maskImage: 'linear-gradient(to bottom, black 60%, transparent 100%)', WebkitMaskImage: 'linear-gradient(to bottom, black 60%, transparent 100%)' }}>
              <div className="absolute inset-x-12 top-10 h-32 rounded-full bg-aquamesh-500/25 blur-3xl sm:inset-x-20 sm:h-40" />
              <img
                className="relative mx-auto max-h-[420px] w-full object-contain drop-shadow-[0_40px_80px_rgba(0,0,0,0.55)] sm:max-h-[520px] lg:max-h-[560px]"
