...
export default function BenchStoryPanels() {
  return (
    <BenchSection
      id="inside"
      eyebrow="Key Advantages"
      title="Three reasons AquaLab belongs on every water-quality bench."
      intro="Lab-grade optical sensing, seamless field-to-lab data continuity, and simple operation"
      tone="mist"
