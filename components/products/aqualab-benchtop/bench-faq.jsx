...
import { faqs } from "./bench-page-data";

export default function BenchFaq() {
  ...
  return (
    <BenchSection
      id="faq"
      eyebrow="FAQ"
      title="Common questions about AquaLab."
      intro="What it measures, how it connects, how it compares to the field probe, and where it fits in the AquaMesh system."
      tone="dark"
